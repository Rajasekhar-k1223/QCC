    ...
    $(function () {
        ...
        if (Role == 1) {
            ...
            if (first == "dashboard") {
                ...
                $("#teamregistration").attr("href", "/AReQCC/Home/Inflow");
                $("#projectselect").attr("href", "/AReQCC/ProjectDetails/PendingForApproval");
            ...
            if (first == "dashboard") {
                ...
                $("#teamregistration").attr("href", "/AReQCC/Home/TeamRegistration");
                $("#projectselect").attr("href", "/AReQCC/ProjectDetails/PendingForApproval");
            ...
            if (first == "dashboard") {
                ...
                $("#teamregistration").attr("href", "/AReQCC/Home/Inflow");
                $("#projectselect").attr("href", "/AReQCC/ProjectDetails/ProjectClosure");
            ...
            $(".HeaderHide").show();
            $(".EditTeam,.Project_Rejected").hide();
        } else if (Role == 4) {
            ...
            if (first == "dashboard") {
                ...
                $("#teamregistration").attr("href", "/AReQCC/Home/TeamRegistration");
                $("#projectselect").attr("href", "/AReQCC/ProjectDetails/ProjectSelectionSheet");
                $("#businessgoals").attr("href", "#");
                //window.location.href = "/Home/Inflow";
            }
            $(".New,.Home,.Profile,.Reports,.Approved,.Rejected,.Project_Selection_Sheet,.EditTeam").show();
            $(".Project_Rejected").show();
        }
        //else
        //{
        //    var first = $(location).attr('pathname');
